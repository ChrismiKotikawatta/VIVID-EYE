      ...
      <div className="detailsContainer">
        ...
        <div className="registerInfo">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="Table">
              <h3 className="newTableHeading">If the patient wears spectacles</h3>
          ...
          {registrationMessage === "Registration successful." && (
            <div className="registerButton">
              ...
              <button className="startbtn" onClick={() => navigate('MainQuestionnaire')}>Start Test</button>
            </div>
          )}
        </div>
      </div>

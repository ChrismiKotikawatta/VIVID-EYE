...
function MainQuestionnaire() {
  ...
  const greenImages = [
    { src: "src/assets/710.jpg", answer: [5] },
    { src: "src/assets/557.jpg", answer: [7] },
    { src: "src/assets/1267.jpg", answer: [8] },
  ];
  ...
  const handleStartTest = () => {
    ...
    if (incorrectAnswers === 3 || incorrectAnswers === 2) {
      navigate("Questionnaire_red");
    } else if (incorrectAnswers === 0 || incorrectAnswers === 1) {

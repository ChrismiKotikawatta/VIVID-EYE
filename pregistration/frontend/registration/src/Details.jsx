...
function Details() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:8081/patients', values)
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="inputBox">
                ...
                <input type="text" placeholder="Enter patient name" id="name" required name = "Name" onChange={handleChange}/>
            </div>
            <div className="inputBox">
                <label htmlFor="nic" className='nic'>NIC :</label>
                <input type="text" placeholder="XXXXXXXXXXXXX" id="nic" required name = "NIC" onChange={handleChange}/>
            </div>
            <div className="inputBox">
                <label htmlFor="phoneNumber" className='num'>Contact Number :</label>
                <input type="tel" placeholder="0XX XXX XXXX" id="phoneNumber" size="10" maxLength={10} required name = "ContactNumber" onChange={handleChange}/>
            </div>
            <div className="inputBox">
            ...
            <div className="inputBox">
                ...
                <input type="text" placeholder="Enter Address" id="address" maxLength={100} name = "Address" onChange={handleChange}/>
            </div>
            <div className="table">

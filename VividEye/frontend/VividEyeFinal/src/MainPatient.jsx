  ...
  return (
      <div className='NewCard'>
        ...
        <div className='cardDetails'>
          ...
          <button className='btnnew' onClick={() => navigate('Details')}>New Patient</button><br></br><br></br>
          <button className='btnex' onClick={() => navigate('PatientDetails')}>Existing Patient</button>
        </div>
    </div>
  )
}
